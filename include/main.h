...
#define LDRIVEF(speed) motorSet(2, speed)
#define LDRIVEB(speed) motorSet(1, speed)
#define RDRIVEF(speed) motorSet(10, speed)
#define RDRIVEB(speed) motorSet(7, speed)

#define LIFT(speed) motorSet(8, speed)
#define FORKS(speed) motorSet(9, speed)
